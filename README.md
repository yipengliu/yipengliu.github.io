...
刘翼鹏是电子科技大学信息与通信工程学院副教授。他曾在鲁汶大学（比利时）、清华大学（北京）、国立清华大学（台湾）、华为技术、西南电子技术研究所访问和工作。他主要从事张量数据分析相关理论、方法与应用工作，以张量计算为基础，重点研究张量分解和低秩优化，拓展协同滤波、轻量化神经网络、对抗攻击、异常检测、信号复原、图像增强、频谱感知、脑机接口等，有效避免传统数据处理中将高维数组矩阵化带来的数据结构损失，同时还能避免大规模数据处理中的“维数灾难”计算难题。
